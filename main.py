...
def main():
  ...
  if args.branch not in ['main', 'stage', 'dev']:
    return
...
# python3 main.py --type drupal10 --domain test.com --repository 'git@github.com:Mocion-co/tuasistentejuridico.git' --branch main
